...
export const surveys: Record<string, SurveyData> = {
  ...
  exotic: {
    ...
    questions: [
      { id: 'business_type', type: 'radio', question: 'Which best describes your business?', options: ['Exotic car rental agency', 'Luxury car sharing host', 'Event/wedding rental specialist', 'Supercar experience company', 'Scaling past Turo / marketplace tools', 'Traditional rental with luxury fleet', 'Other premium vehicle business'], required: true },
