...
export default function BlogCategoryPage() {
  ...
  return (
    <div className="pt-24 min-h-screen bg-[#05070a]">
      <SEOHead
        title={`${formatTaxonomyLabel(category)} Articles | exotiq Journal`}
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <h1 className="font-dfaalt text-4xl text-white mt-3 mb-3">{formatTaxonomyLabel(category)}</h1>
        <p className="text-gray-400 mb-8">Curated guides in this category.</p>
